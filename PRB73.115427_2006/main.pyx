...
class grooving_iso(object):
    ...
    def get_flux_pt_i(self,i):
        if i==0:
            ...
            flux_n=-(self.D*self.gamma/self.kbT)*grd_s_mu
            flux_x=flux_n
        elif i== (self.mp-1):
            flux_x=0
        elif i== (self.mp-2):
            ...
            grd_s_mu=self.get_grad_s_mu_i(i)[0]
            flux_p=-(self.D*self.gamma/self.kbT)*grd_s_mu
    ...
    def __init__(self):
        ...
        #self.L  = 1.0e-4  #1nm=1e-7cm
        self.L  = 1.0e-4  #1nm=1e-7cm
        #numbers of meshing points in 1 dimension
        self.mp = 1000
        self.max_iter = 1
        self.D,self.gamma,self.kbT=2.5e-11,0.7*1e-4,1.38e-23*300
        ...
        self.cos_contact=-0.814  # cos(120deg)
        self.mesh_uniform()
        #self.mesh_test() #verified
        self.dt=1e-9   #unit second
        self.main_loop()
        return
